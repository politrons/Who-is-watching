...
const get_visitor = "curl --location GET 'https://www.facebook.com/profile.php?id=${visitor}' --verbose --user-agent 'Firefox' --cookie 'cookies.txt' --cookie-jar 'cookies.txt' > ${visitor}.html"
